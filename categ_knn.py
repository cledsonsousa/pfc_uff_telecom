##################################################
# Este código usa o modelo KNN para treinar o arquivo tickets.csv 
# e classificar novos tickets baseados nos já criados classificando
# pela descrição do ticket na possível categoria a qual pertence.   
##################################################
## {License_info}
##################################################
...
## ## License: GNU GPLv3
## Version: 1.3.0
## Maintainer: Julia e Marielly
## Email: 
## Status: dev
##################################################
## This code uses KNN model to train file tickets.csv and classify new tickets based 
